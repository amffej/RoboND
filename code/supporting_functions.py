...
def update_rover(Rover, data):
      ...
      #print('YAW: ',Rover.yaw, 'PITCH: ',Rover.pitch, 'ROLL: ', Rover.roll, 'Throttle =', Rover.throttle)
...
def create_output_images(Rover):
      ...
      cv2.putText(map_add,"  Collected: "+str(Rover.samples_collected), (0, 85), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"Mode:", (0, 140), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)  
      cv2.putText(map_add,Rover.mode, (0, 150), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1) 
      cv2.putText(map_add,"KickRocks: "+str(Rover.sequence), (0, 170), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1) 
      cv2.putText(map_add,"NearSample: "+str(Rover.near_sample), (0, 180), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1) 
      cv2.putText(map_add,"PickingUp: "+str(Rover.picking_up), (0, 190), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1) 
