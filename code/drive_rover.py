...
class RoverState():
    def __init__(self):
        ...
        ### MY VARS
        self.stuckyaw = None # Stuck yaw angle
        self.sequence = 1 # Squence control for ROVER steps
        self.sequence_try = 0; #Next Sequence to try
        self.step_time = None # To record the start time of a step
        ## END MY VARS
